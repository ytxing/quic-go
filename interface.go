...
type Session interface {
	...
	// AcceptStream returns the next unidirectional stream opened by the peer, blocking until one is available.
	...
	// OpenUniStreamSync opens a new unidirectional QUIC stream.
	// It blocks until the peer's concurrent stream limit allows a new stream to be opened.
